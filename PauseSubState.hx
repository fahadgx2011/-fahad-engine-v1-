...
class PauseSubState extends MusicBeatSubstate
{
	...
	var menuItemsOG:Array<String> = ['Resume', 'Restart Song', 'Skip Time', 'Toggle Practice Mode', 'Toggle Botplay', 'Change Difficulty', 'Options', 'Exit to menu'];
	...
	override function create()
	{
		...
		var chartingText:FlxText = new FlxText(20, 15 + 101, 0, Language.getPhrase("                                                                               fahad Engine v1.2
		                                                                               Psych Engine v1.0
		                                                                               Friday Night Funkin' v0.2.8").toUpperCase(), 32);
		chartingText.scrollFactor.set();
		chartingText.setFormat(Paths.font('vcrFPS.ttf'), 15);
	...
	{
		PlayState.instance.paused = false; // For lua
		FlxG.sound.music.volume = 0;
		PlayState.instance.vocals.volume = 0;
